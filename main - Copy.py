from PyQt5.QtWidgets import QApplication, QMainWindow, QMenuBar, QMenu, QAction, QDockWidget, QTextEdit, QLabel, QSplitter, QWidget, QVBoxLayout, QToolBar, QPushButton, QSizePolicy, QDialog
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Dock Widgets
        self.frames = {
            'Parameters': QDockWidget("Parameters"),
            'Image Viewer': QDockWidget("Image Viewer"),
            'Text Editor': QDockWidget("Text Editor"),
            'Canvas': QDockWidget("Canvas"),
        }

        self.frames['Parameters'].setWidget(QLabel("Parameters"))
        self.frames['Image Viewer'].setWidget(QLabel("Image Viewer"))
        self.frames['Text Editor'].setWidget(QTextEdit("Text Editor"))
        self.frames['Canvas'].setWidget(QLabel("Canvas"))
        ...
        for frame_name in self.frame_states.keys():
            ...
            action.setChecked(self.frame_states[frame_name])  # Set the initial state of the checkbox based on frame_states
